...
export const BUILTIN_PATCHES: EnginePatch[] = [
  ...
  },
  {
    ...
    meta: {
      blurb:
        'Ion Twin procedural: continuous twin motor bed + sustained 4-formant bellow (shallow phrase breath) + layer-lead morph (motor↔howl↔air) + grit×load. Original synthesis only — no samples.',
...
export function paramMetaForKind(kind: EnginePatch['kind']): ParamMeta[] {
  ...
  return [
    ...master,
    // motorBed
    { id: 'motorEnable', label: 'Motor On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'motorMix', label: 'Motor Mix', min: 0, max: 1, step: 0.01 },
    ...
    // formantHowl
    { id: 'howlEnable', label: 'Howl On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'howlMix', label: 'Howl Mix', min: 0, max: 1, step: 0.01 },
    ...
    // screamBurst
    { id: 'screamEnable', label: 'Scream On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'screamMix', label: 'Scream Mix', min: 0, max: 1, step: 0.01 },
    { id: 'screamBright', label: 'Scream Bright', min: 0, max: 1, step: 0.01 },
    // surge
    { id: 'surgeEnable', label: 'Surge On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'surgeMix', label: 'Surge Mix', min: 0, max: 1, step: 0.01 },
    // airSwoosh
    { id: 'airEnable', label: 'Air On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'airMix', label: 'Air Mix', min: 0, max: 1, step: 0.01 },
    { id: 'wetDry', label: 'Wet/Dry', min: 0, max: 1, step: 0.01 },
    // grit
    { id: 'gritEnable', label: 'Grit On', min: 0, max: 1, step: 1, kind: 'segmented', options: [0, 1] },
    { id: 'gritMix', label: 'Grit Mix', min: 0, max: 1, step: 0.01 },
    // ion support
