...
export type ThemeLayout = 'numerical' | 'arc' | 'line' | 'bar' | 'digital' | 'analog' | 'driver' | 'scanner' | 'time' | 'jet' | 'space' | 'road' | 'custom' | 'enterprise';
...
export const THEMES: ThemePreset[] = [
  ...
  skin('enterprise','RF Enterprise','Gauge Cluster','PopCulture','enterprise','#f5820d','#7d3c98','LCARS-style command interface — Oswald numerals, warp rings and a right-to-left RPM bar.','Warp rings'),
